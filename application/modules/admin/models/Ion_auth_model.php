...
class Ion_auth_model extends CI_Model
{
	...
	public function activate($password, $activation_code, $salt)
	{
		// store the new password and reset the remember code so all remembered instances have to re-login
		$hashed_new_password  = $this->hash_password($password, $salt);
		...
		$successfully_changed_password_in_db = $this->db->update($this->tables['users'], $data, array('activation_code' => $activation_code));
	...
	public function change_password($identity, $old, $new)
	{
		...
		//echo "old_password_matches = ".$old_password_matches;
	...
	public function register($identity, $password, $email, $additional_data = array(), $groups = array())
	{
		...
		$password   = $this->hash_password($password, $salt);
		$activation_code = $this->general_model->random_strings('15');
...
/**/
	...
	public function create_user()
	{
        ...
        $component_id = $this->post->component_id;
