  ...
  <div class="col-xl-12 col-lg-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <table class="table dt-responsive table-striped align-middle">
          ...
          <tbody>
            ...
            <tr>
              <td class="padding_2"><input type="text" class="form-control padding_2" name="task_order" id="task_order-input" value="<?php if(isset($update_data) && !empty($update_data)) echo $update_data->task_order;?>" oninput="save_update('<?php echo $update_data->id;?>','task_order',this.value);" /></td>
              <td class="padding_2"><input type="text" class="form-control padding_2" name="risk_number" id="risk_number-input" value="<?php if(isset($update_data) && !empty($update_data)) echo $update_data->risk_number;?>" oninput="save_update('<?php echo $update_data->id;?>','risk_number',this.value);" /></td>
              <td class="padding_2"><textarea name="updates" id="updates" class="form-control" rows="3" oninput="save_update('<?php echo $update_data->id;?>','updates',this.value);"><?php if(isset($update_data) && !empty($update_data)) echo $update_data->updates;?></textarea></td>
              <td class="padding_2"><?php echo $lastweek_decision;?></td>
              <td class="padding_2"><?php echo $lastweek_action;?></td>
              <td class="padding_2"><textarea name="decision" id="decision" class="form-control" rows="3" oninput="save_update('<?php echo $update_data->id;?>','decision',this.value);"><?php if(isset($update_data) && !empty($update_data)) echo $update_data->decision;?></textarea></td>
              <td class="padding_2"><textarea name="action" id="action" class="form-control" rows="3" oninput="save_update('<?php echo $update_data->id;?>','action',this.value);"><?php if(isset($update_data) && !empty($update_data)) echo $update_data->action;?></textarea></td>
              <td class="padding_2"><textarea name="stakeholder" id="stakeholder" class="form-control" rows="3" oninput="save_update('<?php echo $update_data->id;?>','stakeholder',this.value);"><?php if(isset($update_data) && !empty($update_data)) echo $update_data->stakeholder;?></textarea></td>
              <td class="padding_2"><textarea name="internal_notes" id="internal_notes" class="form-control" rows="3" oninput="save_update('<?php echo $update_data->id;?>','internal_notes',this.value);"><?php if(isset($update_data) && !empty($update_data)) echo $update_data->internal_notes;?></textarea></td>
              <td class="padding_2"><textarea name="fcdo_update" id="fcdo_update" class="form-control" rows="3" oninput="save_update('<?php echo $update_data->id;?>','fcdo_update',this.value);"><?php if(isset($update_data) && !empty($update_data)) echo $update_data->fcdo_update;?></textarea></td>
              <td class="padding_2"><textarea name="risk" id="risk" class="form-control" rows="3" oninput="save_update('<?php echo $update_data->id;?>','risk',this.value);"><?php if(isset($update_data) && !empty($update_data)) echo $update_data->risk;?></textarea></td>
              <td class="padding_2"><textarea name="mitigation" id="mitigation" class="form-control" rows="3" oninput="save_update('<?php echo $update_data->id;?>','mitigation',this.value);"><?php if(isset($update_data) && !empty($update_data)) echo $update_data->mitigation;?></textarea></td>
              <td class="padding_2"><textarea name="residual_risk" id="residual_risk" class="form-control" rows="3" oninput="save_update('<?php echo $update_data->id;?>','residual_risk',this.value);"><?php if(isset($update_data) && !empty($update_data)) echo $update_data->residual_risk;?></textarea></td>
              <?php if(isset($_SESSION['role']) && $_SESSION['role']=="PM"){?>
