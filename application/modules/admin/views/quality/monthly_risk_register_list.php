...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0">
                                                                    <img src="<?php echo base_url();?>content_admin/assets/images/users/avatar-10.jpg" alt="" class="avatar-xxs rounded-circle image_src object-cover">
                                                                </div>
                                                                    ...
                                                                    <div class="position-relative d-inline-block">
                                                                        ...
                                                                        <div class="avatar-lg p-1">
                                                                            <div class="avatar-title bg-light rounded-circle">
                                                                                <img src="<?php echo base_url();?>content_admin/assets/images/users/user-dummy-img.jpg" id="lead-img" class="avatar-md rounded-circle object-cover" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
    ...
    <!-- list.js min js -->
    <script src="<?php echo base_url();?>content_admin/assets/libs/list.js/list.min.js"></script>
    <script src="<?php echo base_url();?>content_admin/assets/libs/list.pagination.js/list.pagination.min.js"></script>

    <!-- Sweet Alerts js -->
    <script src="<?php echo base_url();?>content_admin/assets/libs/sweetalert2/sweetalert2.min.js"></script>
    <!-- crm leads init -->
    <script src="<?php echo base_url();?>content_admin/assets/js/pages/crm-leads.init.js"></script>
