      ...
      <div class="card-header align-items-center d-flex">
        ...
        <div class="page-title-right">
          <ol class="breadcrumb m-0">
            <li><button type="button" class="btn btn-success" data-bs-toggle="offcanvas" href="#milestoneAdd"><i class="ri-add-line align-bottom me-1"></i> Add New</button></li>
          </ol>
        </div>
      </div>
      <!-- end card header -->
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="milestoneAdd" aria-labelledby="offcanvasExampleLabel">
  <div class="offcanvas-header bg-light">
      <h5 class="offcanvas-title" id="offcanvasExampleLabel">Add Milestone Schedule</h5>
      <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
  </div>
  <!--end offcanvas-header-->
  <form method="post" action="<?php echo base_url().'admin/milestone/add_process/';?>" class="d-flex flex-column justify-content-end h-100">
      <div class="offcanvas-body">
          <div class="mb-4">
              <label for="datepicker-range" class="form-label text-muted text-uppercase fw-semibold mb-3">Task Order</label>
              <input type="text" class="form-control" name="task_order" id="task_order-input" data-provider="flatpickr" data-range="true" placeholder="Enter task order">
          </div>
          <div class="mb-4">
              <label for="datepicker-range" class="form-label text-muted text-uppercase fw-semibold mb-3">M Ref</label>
              <input type="text" class="form-control" name="m_ref" id="m_ref-input" data-provider="flatpickr" data-range="true" placeholder="Enter m ref">
          </div>
          <div class="mb-4">
              <label for="datepicker-range" class="form-label text-muted text-uppercase fw-semibold mb-3">Milestone</label>
              <textarea name="milestone" id="milestone" class="form-control" rows="3"></textarea>
          </div>
          <div class="mb-4">
              <label for="datepicker-range" class="form-label text-muted text-uppercase fw-semibold mb-3">Due to FCDO</label>
              <input type="date" class="form-control" name="due_to_fcdo" id="due_to_fcdo-input" data-provider="flatpickr" data-range="true" placeholder="Enter due to fcdo">
          </div>
          <div class="mb-4">
              <label for="datepicker-range" class="form-label text-muted text-uppercase fw-semibold mb-3">Evidence Required</label>
              <textarea name="evidence_required" id="evidence_required" class="form-control" rows="3"></textarea>
          </div>
          <div class="mb-4">
            <label for="datepicker-range" class="form-label text-muted text-uppercase fw-semibold mb-3">Milestone Delivery Risks to Flag</label>
            <textarea name="milestone_delivery_risks_to_flag" id="milestone_delivery_risks_to_flag" class="form-control" rows="3"></textarea>
          </div>
          <div class="mb-4">
            <label for="country-select" class="form-label text-muted text-uppercase fw-semibold mb-3">Status</label>
            <select class="form-control" data-choices data-choices-multiple-remove="true" name="milestone_status" id="milestone_status-select">
              <option value="Active">Active</option>
              <option value="Closed">Closed</option>
            </select>
          </div>
          <div class="mb-4">
            <label for="datepicker-range" class="form-label text-muted text-uppercase fw-semibold mb-3">FCDO Approval</label>
            <input type="text" class="form-control" name="fcdo_approval" id="fcdo_approval-input" data-provider="flatpickr" data-range="true" placeholder="Enter fcdo approval">
          </div>
          <div class="mb-4">
