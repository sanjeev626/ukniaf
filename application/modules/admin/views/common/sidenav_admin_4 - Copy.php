    ...
    <div id="scrollbar">
      <div class="container-fluid">
        ...
        <ul class="navbar-nav" id="navbar-nav">
          ...
          <li class="nav-item"> <a class="nav-link menu-link <?php if($nav == 'dashboard'){ echo 'active'; } ?>" href="<?php echo base_url();?>admin"> <i class="ri-dashboard-2-line"></i> <span data-key="t-widgets">Dashboard</span> </a> </li>
          <li class="nav-item"> <a class="nav-link menu-link <?php if($nav == 'if_priorities_this_week'){ echo 'active'; } ?>" href="<?php echo base_url();?>admin/reporting/if_priorities_this_week"> <i class="ri-cpu-fill"></i> <span data-key="t-widgets">IF Priorities this week</span> </a> </li>
          <li class="nav-item"> <a class="nav-link menu-link <?php if($nav == 'dashboard'){ echo 'active'; } ?>" href="<?php echo base_url();?>admin"> <i class="ri-dashboard-2-line"></i> <span data-key="t-widgets">Dashboard</span> </a> </li>
          <li class="nav-item"> <a class="nav-link menu-link <?php if($nav == 'dashboard'){ echo 'active'; } ?>" href="<?php echo base_url();?>admin"> <i class="ri-dashboard-2-line"></i> <span data-key="t-widgets">Dashboard</span> </a> </li>
          ...
          <li class="nav-item"> <a class="nav-link menu-link <?php if($nav == 'dashboard'){ echo 'active'; } ?>" href="<?php echo base_url();?>admin"> <i class="ri-honour-line"></i> <span data-key="t-widgets">IF Priorities this week</span> </a> </li>
        </ul>
      </div>
      <!-- Sidebar --> 
    </div>
