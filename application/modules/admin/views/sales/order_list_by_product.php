<section class="content">
  <div class="box">
    <?php
    if (!empty($product_id)) {
        $action = base_url() . 'admin/sales/order_list_by_product/' . $product_id;
    } else {
        $action = '';
    }
    ?>
    ...
    <div class="panel-body panel-body-nopadding">      
      ...
      <div class="form-group">
        <!-- <div class="col-md-4">
          ...
          <input type="hidden" class="product_id" id="product_id" name="product_id" value="<?php echo $product_id;?>">
        </div> -->
        <div class="col-md-6">
          <?php echo $this->Product_model->fetch_attributes_by_product($product_id);?>
        </div>
        <div class="col-md-2">
          <button class="btn btn-success btn-flat" type="submit">List All</button>
        </div>
      </div>
    </div>
    <?php echo form_close(); ?> 
