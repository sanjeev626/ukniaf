...
{/metadocument}
*/
	//var $configuration_file = 'linkedin-oauth-client-php/oauth_configuration.json';
	var $configuration_file = APPPATH.'third_party/linkedin/oauth/oauth_configuration.json';
